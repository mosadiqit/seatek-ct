...
class pos_config(models.Model):
    ...
    def _is_installed_module_pos_iot(self):
        installed = self.env['ir.module.module'].sudo().search_count(
            [('name', '=', 'pos_iot'), ('state', '=', 'installed')])
        for config in self:
            config.is_installed_pos_iot = True if installed else False
    ...
    is_installed_pos_iot = fields.Boolean('Pos IoT is installed', compute=_is_installed_module_pos_iot)
