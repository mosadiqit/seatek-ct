odoo.define('pos_retail.big_data', function (require) {
    ...
    screens.ProductScreenWidget.include({
        ...
        // TODO: this method when called very slow, we only called it when products backend change
    ...
    models.load_models([
        ...
        },
        {
            ...
            domain: function (self) {
                var domain = [
                    ['state', 'not in', ['done', 'cancel', 'booked']]
                ];
                var today = new Date();
    ...
    models.PosModel = models.PosModel.extend({
        ...
        sync_with_backend: function (model, datas, dont_check_write_time) {
            ...
            if (model == 'res.partner') {
                ...
                this.trigger('refresh:partner_screen')
            }
