    ...
    models.Order = models.Order.extend({
        ...
        compute_buy_x_get_another_free: function (promotion) {
            ...
            for (var index_id in promotion.product_ids) {
                ...
                if (total_quantity[product_id] && total_quantity[product_id] >= minimum_items) {
                    ...
                    this.add_promotion_line(product, 0, 1, {
                        promotion: true,
                        promotion_multi_buy: true,
        ...
        get_promotions_active: function () {
            ...
            for (var i = 0; i < this.pos.promotions.length; i++) {
                ...
                } else if (promotion['type'] == '10_buy_x_get_another_free' && this.checking_special_client(promotion) && this.checking_promotion_birthday_match_birthdayof_client(promotion) && is_mem_of_promotion_group) {
                ...
                } else if (promotion['type'] == '11_first_order' && this.checking_special_client(promotion) && this.checking_promotion_birthday_match_birthdayof_client(promotion) && is_mem_of_promotion_group) {
