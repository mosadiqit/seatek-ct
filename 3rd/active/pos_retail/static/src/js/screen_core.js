...
odoo.define('pos_retail.screens', function (require) {
            ...
            if (newMode == 'quantity' && this.pos.config.validate_quantity_change) {
                if (is_return) {
                    if (!this.pos.config.apply_validate_return_mode) {
                        ...
                        return this.pos._validate_by_manager("this.chrome.screens['products'].numpad.state.changeMode('quantity')");
                    }
                } else {
                    return this.pos._validate_by_manager("this.chrome.screens['products'].numpad.state.changeMode('quantity')");
                }
            ...
            if (newMode == 'discount' && this.pos.config.validate_discount_change) {
                if (is_return) {
                    if (!this.pos.config.apply_validate_return_mode) {
                        ...
                        return this.pos._validate_by_manager("this.chrome.screens['products'].numpad.state.changeMode('discount')");
                    }
                } else {
                    return this.pos._validate_by_manager("this.chrome.screens['products'].numpad.state.changeMode('discount')");
                }
            ...
            if (newMode == 'price' && this.pos.config.validate_price_change) {
                if (is_return) {
                    if (!this.pos.config.apply_validate_return_mode) {
                        ...
                        return this.pos._validate_by_manager("this.chrome.screens['products'].numpad.state.changeMode('price')");
                    }
    ...
    screens.ActionpadWidget.include({
        ...
        renderElement: function () {
            ...
            this.pos.trigger('refresh:partner_screen');
        }
    });
