...

{
    ...
    'summary': 'Easy to import all odoo data i.e Invoice, Sale, Inventory, Purchase,Payment, Picking, Product, Customer, Product Images, Product Variants, Task, Multiple Statement, Attendances, POS Orders, Multiple Journal Entries',
    "description": """
