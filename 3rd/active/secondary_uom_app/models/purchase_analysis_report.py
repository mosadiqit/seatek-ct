...
class PurchaseReport(models.Model):
	...
	secondary_quantity = fields.Float("Secondary Qty",digits=(1,3))
	...
	def _from(self):
		from_str = """
			purchase_order_line l
				...
				left join uom_uom u3 on (u3.id=l.secondary_uom_id)
				left join uom_uom u4 on (u4.id=t.secondary_uom_id)
