...
LABELCLASS = "col-lg-3 col-md-4 col-form-label"
INNERDIVCLASS = "col-lg-7 col-md-8"
OUTERDIVCLASS = "form-group form-field row type_visibility_depend"
FIELDSINPUTS = {
    "char": {"type" : "text", "class": "o_website_form_input form-control"},
    "integer": {"type" : "number", "class": "o_website_form_input form-control"},
    "float": {"type" : "number", "class": "o_website_form_input form-control", "step": "0.01"},
    "date": {"type" : "date", "class": "o_website_form_input form-control"},
    "datetime": {"type" : "datetime-local", "class": "o_website_form_input form-control"},
    "boolean": {"type" : "checkbox", "class": "o_website_form_input"},
    "text": {"class": "o_website_form_input form-control"},
    "html": {"class": "o_website_form_input form-control"},
    "selection": {"class": "o_website_form_input form-control"},
    "many2one": {"class": "o_website_form_input form-control"},
    "binary": {"type" : "file", "class": "o_website_form_input form-control"},
}
...
class custom_extra_field(models.AbstractModel):
                            ...
                            if field_name:
                                ...
                                if customom_field.ttype in ["binary"]:
                                    spanxml = [(E.span({"t-field": "{}.{}".format(
                                                        ...
                                                        customom_field.binary_field_id.name)})
                                               )]
                    ...
                    for customom_field in custom_field_ids:
                        if customom_field.input_placement == place:
                            ...
                            if field_name:
                                inner_xml = []
                                # 1
                                label_attrs = {"class": LABELCLASS, "for": field_name}
                                inner_xml.append(E.label(u"{}:".format(customom_field.name), label_attrs))
                                # 2
                                ...
                                outer_div_class = customom_field.required and customom_field.ttype not in ["boolean"]\
                                                  ...
                                                  or OUTERDIVCLASS
                                final_xml.append(E.div(*(inner_xml), {"class": outer_div_class}))
    ...
    def _retrieve_type_input(self):
        ...
        # 1
        label_attrs = {"class": LABELCLASS, "for": self._type_field}
        inner_xml = [E.label(_("Type:"), label_attrs)]
        # 2
        input_attrs = {"name": self._type_field, "class": "o_website_form_input form-control select_type_input"}
        options_xml = []
        ...
        if available_types:
            ...
            inner_xml.append(inner_div)
            # 4
            final_xml = [E.div(*(inner_xml), {"class": OUTERDIVCLASS})]
