# -*- coding: utf-8 -*-
{
    ...
    "author": "Odoo Tools",
    "website": "https://odootools.com/apps/12.0/custom-fields-core-338",
    ...
    "description": """
    Often Odoo standard fields are not enough to reflect your business specifics, while customization requires developer competences. This tool is introduced to make everything as simple as creating a new document in Odoo. The app let you create new properties of specified documents fast and comfortable.<br/>
This module is a technical core and is not of use without a document-specific extension. Please select a desired one below:
