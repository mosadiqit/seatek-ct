...
class consignment_log_ept(models.Model):
    ...
    pending_attachment = fields.Many2one('ir.attachment', string="Pending Records File")
    pending_datas = fields.Binary(string="Pending Records File", related='pending_attachment.datas')
    pending_datas_fname = fields.Char('Pending Filename', related='pending_attachment.datas_fname')
    
    main_attachment = fields.Many2one('ir.attachment', string="Main File Imported")
    main_datas = fields.Binary(string="Main File Imported", related='main_attachment.datas')
    main_datas_fname = fields.Char('Main Filename', related='main_attachment.datas_fname')
    ...
    def view_consignment_transactions(self):
        ...
        try:      
            ...
            result['views'] = [(tree_view and tree_view.id or False, 'tree'), (form_view and form_view.id or False, 'form')]
